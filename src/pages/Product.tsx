            ...
            <div className="lg:py-4">
              ...
              <div className="flex gap-4 mb-6">
                ...
                <Button
                  ...
                  disabled={!inStock}
                  className="flex-1 h-12 bg-foreground text-background hover:bg-foreground/90 text-xs tracking-widest"
                >
              ...
              <Accordion type="multiple" defaultValue={["description"]} className="border-t border-border/30">
                <AccordionItem value="description">
                  <AccordionTrigger className="text-xs tracking-widest hover:no-underline">
                    DESCRIPTION
                  </AccordionTrigger>
                ...
                <AccordionItem value="details">
                  ...
                  <AccordionContent>
                    <ul className="text-sm text-foreground/70 space-y-2">
                      {selectedVariant?.sku && (
                        <li>
                          <span className="text-foreground/50">SKU:</span> {selectedVariant.sku}
                        </li>
                      )}
                      <li>
                        <span className="text-foreground/50">GST:</span> {product.gstRate}% included
                      </li>
